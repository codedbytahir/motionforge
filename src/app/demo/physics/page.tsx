...
const DemoPhysics = dynamic(() => import('@/lib/remotion/demo/DemoPhysics').then(m => m.DemoPhysics), { ssr: false });
      ...
      <div style={{ width: '100%', maxWidth: '1200px' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h1 style={{ color: '#10b981', fontSize: '2rem', fontWeight: 'bold', marginBottom: '0.5rem' }}>
            RapierJS Physics Demo
          </h1>
          <p style={{ color: '#6b7280', fontSize: '0.875rem' }}>
            Falling shapes, Newton&apos;s cradle, stacking tower, and physics explosion
          </p>
        </div>
        <Player
